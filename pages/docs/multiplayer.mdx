...
<Image src={'/players_pool.webp'} width={500} height={500} style={{'padding-top': '10px'}} ></Image>
...
<Image src={'/multiplayer_events_emitting.webp'} width={400} height={400} style={{'padding-top': '10px'}} ></Image>
...
<Image src={'/recursive_proofs.webp'} width={700} height={700} style={{'padding-top': '10px'}} ></Image>
