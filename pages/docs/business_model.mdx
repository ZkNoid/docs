...
<video width="400px" height="400px" autoPlay muted loop style={{'padding-top': '10px'}}>
  <source src={'/zknoid_bridge.mp4'} type="video/mp4" />
...
Project revenue is collected inside a multisig vault and used to buy-back token at least once every three months.
