...
## Arkanoid game verification overview
...
<Image src={'/coord.svg'} width={500} height={500} style={{paddingTop: '10px'}} ></Image>
...
<Image src={'/left_collision.svg'} width={200} height={200} style={{paddingTop: '10px'}} ></Image>
