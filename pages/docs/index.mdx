...
__Randzu game__: multiplayer, matchmaking, background gasless sessions, paid competitions, game verification. ```For now it's recommended to test the game using two browsers e.g. Chrome and Firefox```
