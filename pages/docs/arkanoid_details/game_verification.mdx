...
<Image src={'/coord.svg'} width={500} height={500} alt='Coordinates' style={{paddingTop: '10px'}} ></Image>
...
<Image src={'/left_collision.svg'} width={200} height={200} alt='Left collision' style={{paddingTop: '10px'}} ></Image>
...
<Image src={'/top_collision.svg'} width={300} height={300} style={{paddingTop: '10px'}} ></Image>
...
<Image src={'/right_collision.svg'} width={300} height={300} style={{paddingTop: '10px'}} ></Image>
...
<Image src={'/vertical_brick.svg'} width={300} height={300} style={{paddingTop: '10px'}} />
