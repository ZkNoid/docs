...
- Should be possible to publish research publically in [ZkNoid blog](https://medium.com/@zknoid)

#### Grant budget
Research is rewarded with __50$ -- 500$__ based on research quality. Currently grant is payed in MINA tokens. 
It will be payed in project token once launched. Amounts may be changed in future
