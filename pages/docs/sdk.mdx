...
- Usage example: [ArkanoidGameHub.ts](https://github.com/ZkNoid/zknoid/blob/develop/packages/chain/src/arkanoid/ArkanoidGameHub.ts)
...
- Usage example: [RandzuLogic.ts](https://github.com/ZkNoid/zknoid/blob/develop/packages/chain/src/randzu/RandzuLogic.ts)
