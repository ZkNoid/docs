...
Competition utilization type can be found in arkanoid game hub – [GameHub.ts#L179](https://github.com/ZkNoid/zknoid/blob/develop/packages/chain/src/GameHub.ts#L179)
