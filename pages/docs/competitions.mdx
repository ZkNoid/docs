...
Competition data type can be found here – [types.ts#L19](https://github.com/ZkNoid/zknoid/blob/develop/packages/chain/src/arkanoid/types.ts#L19)<br />
Competitions and leaderboard system is called game hub and can be found here – [GameHub.ts](https://github.com/ZkNoid/zknoid/blob/develop/packages/chain/src/engine/GameHub.ts)
